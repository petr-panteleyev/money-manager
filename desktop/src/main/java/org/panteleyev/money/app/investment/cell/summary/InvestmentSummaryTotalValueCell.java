...
public class InvestmentSummaryTotalValueCell extends TreeTableCell<InvestmentSummaryTreeData, InvestmentSummaryTreeData> {
    @Override
    protected void updateItem(InvestmentSummaryTreeData summary, boolean empty) {
        ...
        if (summary == null || empty) {
            ...
            setText(summary.totalValue().setScale(2, RoundingMode.HALF_UP).toString());
        }
    }
}
