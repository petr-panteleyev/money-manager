...
public class InvestmentExchangeFeeCell extends TableCell<InvestmentDeal, InvestmentDeal> {
    @Override
    public void updateItem(InvestmentDeal investmentDeal, boolean empty) {
        ...
        if (empty || investmentDeal == null) {
            ...
            setText(investmentDeal.exchangeFee().setScale(2, RoundingMode.HALF_UP).toString());
        }
    }
}
