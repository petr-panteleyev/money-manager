...
public final class Shortcuts {
    ...
    public static final KeyCodeCombination SHORTCUT_OPEN_BRACKET =
            new KeyCodeCombination(OPEN_BRACKET, SHORTCUT_DOWN);
    public static final KeyCodeCombination SHORTCUT_CLOSE_BRACKET =
            new KeyCodeCombination(CLOSE_BRACKET, SHORTCUT_DOWN);
    public static final KeyCodeCombination SHORTCUT_ALT_OPEN_BRACKET =
            new KeyCodeCombination(OPEN_BRACKET, SHORTCUT_DOWN, SHIFT_DOWN);
    public static final KeyCodeCombination SHORTCUT_ALT_CLOSE_BRACKET =
            new KeyCodeCombination(CLOSE_BRACKET, SHORTCUT_DOWN, SHIFT_DOWN);
    public static final KeyCodeCombination SHORTCUT_BACK_SLASH =
            new KeyCodeCombination(BACK_SLASH, SHORTCUT_DOWN);
