...
public class InvestmentBrokerFeeCell extends TableCell<InvestmentDeal, InvestmentDeal> {
    @Override
    public void updateItem(InvestmentDeal investmentDeal, boolean empty) {
        ...
        if (empty || investmentDeal == null) {
            ...
            setText(investmentDeal.brokerFee().setScale(2, RoundingMode.HALF_UP).toString());
        }
    }
}
