...
public class PeriodicPaymentCreditedAccountCell extends TableCell<PeriodicPayment, PeriodicPayment> {
    @Override
    public void updateItem(PeriodicPayment periodicPayment, boolean empty) {
        ...
        cache().getAccount(periodicPayment.accountCreditedUuid()).ifPresent(account -> {
