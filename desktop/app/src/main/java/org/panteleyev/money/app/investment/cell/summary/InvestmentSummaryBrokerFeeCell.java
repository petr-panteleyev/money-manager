...
public class InvestmentSummaryBrokerFeeCell extends TreeTableCell<InvestmentSummaryTreeData, InvestmentSummaryTreeData> {
    @Override
    protected void updateItem(InvestmentSummaryTreeData summary, boolean empty) {
        ...
        if (summary == null || empty) {
            ...
            setText(summary.totalBrokerFee().setScale(2, RoundingMode.HALF_UP).toString());
        }
    }
}
